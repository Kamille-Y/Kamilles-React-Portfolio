        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    ...
                    <ContactItem icon={email} text1={'kyoung15@mail.bw.edu'} text2={'abcloremipsum@gmail.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'Ceveland Ohio'} text2={'United States'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
